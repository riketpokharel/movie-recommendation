...
const characters = [
    { name: "Cillian Murphy", role: "Actor", image: "/assets/images/oppenheimer.jpg" }, // Reuse oppenheimer
    { name: "Margot Robbie", role: "Actress", image: "/assets/images/barbie.jpg" }, // Reuse barbie
    { name: "Leonardo DiCaprio", role: "Actor", image: "/assets/images/inception-thumb.jpg" }, // Reuse inception
    { name: "Christian Bale", role: "Actor", image: "/assets/images/darkknight-thumb.jpg" }, // Reuse darkknight
            ...
            <div className="container mx-auto px-6 md:px-16">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-8 md:gap-12">
                    ...
                    <div className="flex flex-col items-center group cursor-pointer">
                        ...
                        <h3 className="mt-4 text-lg font-medium text-gray-400 group-hover:text-white transition-colors">More</h3>
                    </div>
                </div>
            </div>
        </section>
