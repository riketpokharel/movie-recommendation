...
const collections = [
  ...
  },
  {
    ...
    description:
      "Swing through the multiverse with your friendly neighborhood hero.",
    color: "from-red-900",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        {collections.map((collection, index) => (
          ...
          >
            ...
            {/* Gradient Overlay */}
            <div
              className={`absolute inset-0 bg-gradient-to-t ${collection.color} via-black/40 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300`}
            />
