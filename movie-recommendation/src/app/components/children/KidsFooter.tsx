            ...
            <div className="container mx-auto relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-gray-400 max-w-sm">
                            Making entertainment safe, fun, and magical for everyone. diverse stories for diverse minds! 🚀
                        </p>
                    </div>

                    <div className="flex gap-4">
                        {[FaFacebook, FaTwitter, FaInstagram, FaYoutube].map((Icon, i) => (
                            <div key={i} className="bg-white/10 p-3 rounded-full hover:bg-pink-500 hover:scale-110 transition-all cursor-pointer">
                                <Icon size={20} />
                            </div>
                        ))}
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 text-sm font-semibold text-gray-300 text-center md:text-left">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <a href="#" className="hover:text-yellow-400">Parental Controls</a>
                        <a href="#" className="hover:text-yellow-400">Account</a>
                    </div>
                    <div className="flex flex-col gap-3">
                        <span className="text-white font-bold opacity-50 mb-1 uppercase tracking-wider text-xs">Legal</span>
                    ...
                    <div className="flex flex-col gap-3">
                        <span className="text-white font-bold opacity-50 mb-1 uppercase tracking-wider text-xs">Contact</span>
                        <p>Questions? Ask your parents!</p>
                    </div>
                </div>

                <div className="border-t border-white/10 pt-8 text-center text-gray-500 text-sm">
                    <p>&copy; {new Date().getFullYear()} MyMovie Kids. All Rights Reserved. Stay Awesome!</p>
                </div>
            </div>
        </footer>
    );
